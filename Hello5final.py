...
def score_display(game_state):
    ...
    if game_state == 'game_over':
        ...
        score_rect = score_surface.get_rect(center=(580, 300))
        screen.blit(score_surface, score_rect)

        high_score_surface = game_font.render(
            str(bestscore), True, (255, 255, 255))
        high_score_rect = high_score_surface.get_rect(center=(600, 400))
        screen.blit(high_score_surface, high_score_rect)

        score_Text = game_font.render('Score: ', True, (255, 255, 255))
        score_Text_rect = score_Text.get_rect(center=(508, 300))
        screen.blit(score_Text, score_Text_rect)

        high_score_Text = game_font.render(
            'High Score: ', True, (255, 255, 255))
        high_score_Text_rect = high_score_Text.get_rect(center=(478, 400))
